...
- Engine (keys required): https://app.netie.ai/cortex and local http://127.0.0.1:8010/cortex
- Not a new hostname. Do not use constructor.netie.ai.

ChatGPT-style box compiles the canvas. Ghost mode dry-runs (no writes). Propose 3 ranks Cortex coordination patterns. Maximize applies the winner.
