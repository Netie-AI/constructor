...
- Engine URL (existing host): `https://app.netie.ai/cortex` and local `http://127.0.0.1:8010/cortex`. Key-gated (`X-API-Key` or `/cortex/session` cookie). Do not invent `constructor.netie.ai`.
